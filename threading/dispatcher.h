...
int dispatch_asyn(Queue* q, Functor f, Params... params)
{
    assert(q != nullptr);
	{
...
template<class Queue, class Functor, class... Params >
void dispatch_sync(Queue* q, Functor f, Params... params)
{
    assert(q != nullptr);
...
dispatch_invoke(Queue* q,  Functor f, Params... params)
{
    assert(q != nullptr);
